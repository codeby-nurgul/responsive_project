// jQuery UI Button Widget Initialization (for Save Changes button)
$(function () {
  $(".btn-settings-save").button();
});

// jQuery UI Datepicker Initialization & jQuery Validate Plugin Setup
$(function () {
...
// Tracks daily task completion using a jQuery UI progress bar and displays a success popup when at least 5 tasks are completed.
